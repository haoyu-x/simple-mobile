...
class DiffusionPolicy:
    ...
    def _convert_action(self, action):
        # Training layout (bimanual real):
        #   base_vel[0:3] | L: pos[3:6] rot6d[6:12] grip[12:13] | R: pos[13:16] rot6d[16:22] grip[22:23]
        act_sequence = []
        for act in action:
            action_dict = {
                'base_velocity': act[0:3],
                'arm_left': {
                    'arm_pos': act[3:6],
                ...
                'arm_right': {
                    'arm_pos': act[13:16],
                    'arm_quat': self.rotation_transformer.forward(act[16:22])[[1, 2, 3, 0]],
                    'gripper_pos': act[22:23],
                },
            }
